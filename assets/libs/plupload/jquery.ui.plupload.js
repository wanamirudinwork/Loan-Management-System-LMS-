			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						'<div class="plupload_logo"><i class="fa fa-cloud-upload"></i></div>' +
						'<div class="plupload_header_title">' + _("Upload Photos") + '</div>' +
						'<div class="plupload_header_text">' + _("Add photos and the upload will start automatically.") + '</div>' +
				...
				'<tr><td colspan="4" class="c">' +
					'<div class="plupload_started plupload_hidden plprogress"><!-- Hidden -->' +
						'<table><tr><td>' +
						'<div class="bar">' +
				...
				'</td></tr>' +
				'<tr>' +
					'<td class="plupload_cell plupload_file_name" colspan="4">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("Add Photos") + '</a>&nbsp;' +
							//'<a class="plupload_button plupload_start">' + _("Upload") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_stop plupload_hidden">'+_("Stop") + '</a>&nbsp;' +
						'</div>' +
						/*
