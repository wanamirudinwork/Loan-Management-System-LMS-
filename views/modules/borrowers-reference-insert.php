            ...
            <div class="content">
				...
				<div class="widget">
					<div class="widget-header transparent">
						<h2><strong>Insert</strong> Reference</h2>
					</div>
					<div class="widget-content padding">
						<form id="backForm" class="form-horizontal" role="form">
							...
							<div class="form-group">								
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="nric_format" maxlength="14" class="form-control nric-number" name="nric_new" value="">
                                </div>
								<label class="col-sm-1 control-label">NRIC(Old)</label>
                                <div class="col-sm-4" id="contacts">
                                    <input type="text" class="form-control" maxlength="20" name="nric_old"  value="">
                                </div>
                            </div>							
							<div class="form-group">
