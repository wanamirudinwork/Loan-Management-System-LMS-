                        ...
                        <form class='form-horizontal' role='form'>
                            <table class="table table-striped table-bordered datatable" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <th width="250 "class="c pointer">Last Payment Date</th>
                                    <th width="250 "class="c pointer">Loan Balance (RM)</th>
...
<script>
    $(function(){
        $(document).on('click', '.btn-filter-date', function(){
            ...
            location.href = rootPath + 'report/payment?date_from=' + date_from + '&date_to=' + date_to;
        });
        ...
        $(document).on('click', '.btn-export', function(){
            ...
            location.href = rootPath + 'report/payment?date_from=' + date_from + '&date_to=' + date_to + '&export=1';
        });
    });
</script>