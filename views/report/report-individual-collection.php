                ...
                <div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h2><strong>Individual Collection</strong>  Report</h2>
		...
		<script>
			$(function(){
				$(document).on('click', '.btn-filter-date', function(){
					...
					location.href = rootPath + 'report/individualcollection?date_from=' + date_from + '&date_to=' + date_to;
				});
				$(document).on('click', '.btn-export', function(){
					date_from = $('[name="date_from"]').val();
					date_to = $('[name="date_to"]').val();

					location.href = rootPath + 'report/individualcollection?date_from=' + date_from + '&date_to=' + date_to + '&exportdate=1';
				});
				$(document).on('click', '.btn-export-borrower', function(){
            borrowerID = $('[name="borrowerID"]').val();

            location.href = rootPath + 'report/individualcollection?borrowerID=' + borrowerID + '&exportborrower=1';
        });
		$(document).on('click', '.btn-export-officer', function(){
            adminID = $('[name="adminID"]').val();

            location.href = rootPath + 'report/individualcollection?adminID=' + adminID + '&exportofficer=1';
        });

		$(document).on('click', '.btn-filter-borrower', function(){
            borrowerID = $('[name="borrowerID"]').val();

            location.href = rootPath + 'report/individualcollection?borrowerID=' + borrowerID;
        });
		$(document).on('click', '.btn-filter-officer', function(){
            adminID = $('[name="adminID"]').val();

            location.href = rootPath + 'report/individualcollection?adminID=' + adminID;
        });
			});
				</script>