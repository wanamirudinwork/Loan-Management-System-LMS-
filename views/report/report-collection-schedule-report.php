...
<!--                            <input type="text" name="date_from" class="form-control datepicker-input" placeholder="dd-mm-yyyy" data-date-format="dd-mm-yyyy" value="--><?php //echo $date_from; ?><!--"> to-->
<!--                            <input type="text" name="date_to" class="form-control datepicker-input" placeholder="dd-mm-yyyy" data-date-format="dd-mm-yyyy" value="--><?php //echo $date_to; ?><!--">-->
...
<script>
    $(function(){
        $(document).on('click', '.btn-filter-borrower', function(){
            ...
            location.href = rootPath + 'report/collection-schedule-report?borrowerID=' + borrowerID;
        });

        $(document).on('click', '.btn-export-borrower', function(){
            borrowerID = $('[name="borrowerID"]').val();

            location.href = rootPath + 'report/collection-schedule-report?borrowerID=' + borrowerID + '&exportborrower=1';
        });
    });
</script>
...
<!---->
<!--location.href = rootPath + 'report/collection-schedule-report?date_from=' + date_from + '&date_to=' + date_to;-->
<!--});-->
<!---->
...
<!--date_to = $('[name="date_to"]').val();-->
<!---->
<!--location.href = rootPath + 'report/collection-schedule-report?date_from=' + date_from + '&date_to=' + date_to + '&exportdate=1';-->
<!--});-->